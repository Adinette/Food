    ...
    <div class="max-w-screen-xl mx-auto flex flex-col items-center space-y-4 p-6">
        ...
        <form action="" id="form" class="bg-gray-100 shadow w-2/3 p-4 space-y-4">
            <div class="space-y-2">
                ...
                <input type="email" name="email" id="email" v-model="creation.email"  class="rounded w-full p-2">
            </div>
            <div class="space-y-2">
                <label for="" class="font-medium text-gray-700">Mot de passe :</label>
                <input type="password" name="password" id="password" v-model="creation.password" class="rounded w-full p-2">
            </div>
            <div class="space-y-2">
                <label for="" class="font-medium text-gray-700">Confirmer mot de passe :</label>
                <input type="password" name="passwor" id="passwor" v-model="creation.passwor" class="rounded w-full p-2">
            </div>
